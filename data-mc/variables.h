...
std::vector<global::variable> variables = {
  ...
  { .varname = "Dpt", .var = "Dpt", .vartex = "#it{p}_{T} [GeV/c]", .varmin = 2., .varmax = 5., .nbin = 80, .logy = 0, .isbranch = 1 },
  ...
  { .varname = "Dtrk1Pt", .var = "Dtrk1Pt", .vartex = "Track 1#scale[0.5]{ }#it{p}_{T} [GeV/c]", .varmin = 0, .varmax = 5, .nbin = 50, .logy = 1, .isbranch = 1 },
  { .varname = "Dtrk2Pt", .var = "Dtrk2Pt", .vartex = "Track 2#scale[0.5]{ }#it{p}_{T} [GeV/c]", .varmin = 0, .varmax = 5, .nbin = 50, .logy = 1, .isbranch = 1 },
  { .varname = "Dtrk1PtErr", .var = "Dtrk1PtErr", .vartex = "Track 1 #sigma(p_{T}) [GeV/c]", .varmin = 0, .varmax = 1, .nbin = 50, .logy = 1, .isbranch = 1 },
  { .varname = "Dtrk2PtErr", .var = "Dtrk2PtErr", .vartex = "Track 2 #sigma(p_{T}) [GeV/c]", .varmin = 0, .varmax = 1, .nbin = 50, .logy = 1, .isbranch = 1 },
  ...
  { .varname = "Dip3Dsig", .var = "Dip3D/Dip3derr", .vartex = "DCA significance", .varmin = 0, .varmax = 25, .nbin = 25, .logy = 1, .isbranch = 0 },
};
