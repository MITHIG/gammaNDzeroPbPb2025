...
std::vector<xjjana::variable> vars = {
  ...
  { .varname = "Dtrk1Pt", .var = "Dtrk1Pt", .vartex = "Track 1 p_{T} [GeV]", .varmin = 0, .varmax = 8, .nbin = 40, .logy = 1 },
  { .varname = "Dtrk2Pt", .var = "Dtrk2Pt", .vartex = "Track 2 p_{T} [GeV]", .varmin = 0, .varmax = 8, .nbin = 40, .logy = 2 },
  { .varname = "Dchi2cl", .var = "Dchi2cl", .vartex = "Secondary vertex prob", .varmin = 0, .varmax = 1, .nbin = 50, .logy = 0 },
  { .varname = "Dtrk1ptrel", .var = "Dtrk1PtErr/Dtrk1Pt", .vartex = "Track 1 #sigma(p_{T})/p_{T}", .varmin = 0, .varmax = 1, .nbin = 50, .logy = 0 },
  { .varname = "Dtrk2ptrel", .var = "Dtrk2PtErr/Dtrk2Pt", .vartex = "Track 2 #sigma(p_{T})/p_{T}", .varmin = 0, .varmax = 2, .nbin = 50, .logy = 0 },
  { .varname = "Dtrk1nhit", .var = "Dtrk1PixelHit+Dtrk1StripHit", .vartex = "Track 1 number of hits", .varmin = 0, .varmax = 20, .nbin = 20, .logy = 0 },
  { .varname = "Dtrk2nhit", .var = "Dtrk2PixelHit+Dtrk2StripHit", .vartex = "Track 2 number of hits", .varmin = 0, .varmax = 20, .nbin = 20, .logy = 0 },
};
