...
std::vector<xjjana::variable> vars = {
  ...
  { .varname = "HFEMaxPlusforest",     .var = "HFEMaxPlus_forest",           .vartex = "Leading HF+ PF (3 < |#eta| < 6) E_{max} [GeV]",               .varmin = 0,   .varmax = 40,   .nbin = 100,  .logy = 0 },
  { .varname = "HFEMaxPlusforest-zoom", .var = "HFEMaxPlus_forest",           .vartex = "Leading HF+ PF (3 < |#eta| < 6) E_{max} [GeV]",               .varmin = 0,   .varmax = 25,   .nbin = 100,  .logy = 0 },
  { .varname = "HFEMaxMinusforest",    .var = "HFEMaxMinus_forest",          .vartex = "Leading HF- PF (3 < |#eta| < 6) E_{max} [GeV]",               .varmin = 0,   .varmax = 40,   .nbin = 100,  .logy = 0 },
  { .varname = "HFEMaxMinusforest-zoom", .var = "HFEMaxMinus_forest",           .vartex = "Leading HF- PF (3 < |#eta| < 6) E_{max} [GeV]",               .varmin = 0,   .varmax = 25,   .nbin = 100,  .logy = 0 },
